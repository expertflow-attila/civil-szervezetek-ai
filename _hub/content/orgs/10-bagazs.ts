  ...
  readyPackages: [
    {
      ...
      problem:
        "120-150 mentor heti eset-jegyzete 30-60 perc/db. Diktált 5 perces összefoglalóból Claude strukturált jegyzetet ír.",
      saving: "80% idő",
      folderName: "01-mentor-jegyzet-strukturalo",
    ...
    },
    {
      ...
      problem: "BlackRock + Morgan Stanley pénzügyi-igényes 8-12 óra/hó. AI-vel 1-2 óra alatt.",
      saving: "85% idő",
      folderName: "02-donor-jelentes-vallalati",
      files: ["README", "lépésről lépésre", "1 prompt"],
    },
    {
      number: "03",
      title: "SROI éves mérés (Claude Code)",
      cloudProduct: "Claude Code",
      setupTime: "15 perc",
      firstValueTime: "1 nap",
      problem:
        "Évi 80-120 órás SROI-elemzés. AI-vel 30-40 óra git-verziózott workflow-val.",
      saving: "60% idő",
      folderName: "03-sroi-eves-meres",
      files: ["README", "CLAUDE.md", "1 prompt"],
    },
  ],
};
