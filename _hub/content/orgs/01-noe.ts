...
export const pageContent: PageContent = {
  ...
  download: {
    ...
    contents: [
      ...
      "csomagok/ — 3 kész operatív munkacsomag",
    ],
  },
  readyPackages: [
    {
      ...
      setupTime: "8-10 óra",
      firstValueTime: "1 hét pilot",
      problem:
        "250 helyi vezető naponta hívja a központi irodát ismétlődő kérdésekkel. Egy közös Claude Project = önkiszolgáló válasz forrás-hivatkozással.",
      saving: "95% központi telefon-teher",
      folderName: "01-helyi-vezeto-project",
      files: ["README", "lépésről lépésre", "system-prompt", "2 prompt", "cowork", "schedule", "sample"],
    },
    {
      number: "02",
      title: "Tagi email-triage",
      cloudProduct: "Claude Desktop + MCP",
      setupTime: "15 perc",
      firstValueTime: "30 perc",
      problem: "30-50 napi tagi email kategorizálva, 80% válasz-vázlattal.",
      saving: "70% email-feldolgozás",
      folderName: "02-tagi-email-triage",
      files: ["README", "lépésről lépésre", "system-prompt", "2 prompt"],
    },
    {
      number: "03",
      title: "Pályázatírás (Claude Code)",
      cloudProduct: "Claude Code",
      setupTime: "10 perc",
      firstValueTime: "1-2 óra",
      problem: "Évi 5-15 pályázat × 8-20 óra. AI-vel 3-8 óra/db.",
      saving: "60% idő",
      folderName: "03-palyazatiras-bga",
      files: ["README", "CLAUDE.md", "session-prompt", "2 prompt", "sample"],
    },
  ],
};
